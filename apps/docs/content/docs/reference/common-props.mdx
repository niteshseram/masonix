...
| `role`                     | `"grid" \| "list" \| "none"`                  | `"list"`       | All        | `"grid"` is retained for compatibility and maps to list semantics. |
| `aria-label`               | `string`                                       | -              | All        | Accessible label for the layout.                           |
| `announceItemCountChanges` | `boolean`                                      | `true`         | All        | Announces item-count changes through a polite live region. |
