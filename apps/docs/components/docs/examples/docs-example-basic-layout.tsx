...
function TaskCard({ task }: { task: Task }) {
  return (
    ...
    >
      <div className="absolute inset-y-0 left-0 w-1" style={{ background: task.accent }} />
      <div className="flex items-center justify-between gap-3 pl-2">
        <span className="text-xs font-medium text-zinc-500 dark:text-zinc-400">{task.area}</span>
