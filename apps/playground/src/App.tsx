      ...
      <header className="flex h-11 shrink-0 items-center gap-3 border-b border-zinc-800 bg-[#111111] px-4">
        ...
        <div className="flex items-center gap-2">
          <div className="grid grid-cols-2 gap-[3px]">
            <div className="h-[7px] w-[7px] rounded-[2px] bg-blue-400/70" />
            <div className="h-[9px] w-[7px] rounded-[2px] bg-blue-500/80" />
            <div className="h-[9px] w-[7px] rounded-[2px] bg-blue-500/60" />
            <div className="h-[7px] w-[7px] rounded-[2px] bg-blue-400/90" />
          </div>
